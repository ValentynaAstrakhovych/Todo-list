...
export default function Ready () {
    ...
    return (
        <div className="md:mr-2 mb-3 container px-5 py-5 bg-sky-200 flex flex-col justify-between rounded h-fit">
           <h2 className="text-sky-900 text-xl font-bold text-center mb-3">Ready</h2>
           <div>
            <ul>{moveTask.map((task, index)=><li className="text-sky-900 font-normal text-md mb-2 bg-sky-100 rounded px-2 py-2 flex flex-row flex-nowrap justify-between items-center mb-2">{task}
            { <div><button 
            type="button"
